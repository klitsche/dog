...
class Constant implements ElementInterface, FqsenAwareInterface, DocBlockAwareInterface, VisibilityAwareInterface, ProjectAwareInterface, DataAwareInterface
{
    use DocBlockTrait;
    use VisibilityTrait;
    use ProjectTrait;
